...
SCENARIOS: dict[str, Scenario] = {
    "nominal": Scenario(
        "nominal",
        "three similar satellites; capture slightly outpaces the link",
        (
            _sat("sat-a", 0, capture_period_s=4.0),
            _sat("sat-b", 1, capture_period_s=4.0),
            _sat("sat-c", 2, capture_period_s=4.0),
        ),
    ),
    "memory_pressure": Scenario(
        "memory_pressure",
        "sat-c captures every 0.5 s into 8 slots: constant eviction",
        (
            _sat("sat-a", 0, capture_period_s=4.0),
            _sat("sat-b", 1, capture_period_s=4.0),
    ...
    "low_scorer": Scenario(
        "low_scorer",
        "sat-b scores 15 points lower than its peers on every frame",
        (
            _sat("sat-a", 0, capture_period_s=4.0),
            _sat("sat-b", 1, capture_period_s=4.0, score_bias=-15.0),
            _sat("sat-c", 2, capture_period_s=4.0),
        ),
    ),
    "revoke": Scenario(
        "revoke",
        "sat-c is granted slots and never transmits",
        (
            _sat("sat-a", 0, capture_period_s=4.0),
            _sat("sat-b", 1, capture_period_s=4.0),
    ...
    "lossy": Scenario(
        "lossy",
        "bus duplicates 20%, reorders 10%, drops 2% of datagrams",
        (
            _sat("sat-a", 0, capture_period_s=4.0),
            _sat("sat-b", 1, capture_period_s=4.0),
            _sat("sat-c", 2, capture_period_s=4.0),
    ...
    "late_joiner": Scenario(
        "late_joiner",
        "sat-c boots 40 s into the pass with no configuration anywhere",
        (
            _sat("sat-a", 0, capture_period_s=4.0),
            _sat("sat-b", 1, capture_period_s=4.0),
