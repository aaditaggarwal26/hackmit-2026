...
def awkward_frames(seed: int = 1) -> list[tuple[str, np.ndarray, np.ndarray]]:
    ...
    return [
        ...
        ("ramp", ramp, z), ("checkerboard", checker.astype(np.uint8), z), ("stripes_max_sobel", stripes, z),
        ("border_only", border, z), ("noise", noise, z), ("noise_vs_noise", noise, noise2),
        ("identical_to_ref", noise, noise), ("cloud_thr_exact", thr, z), ("cloud_thr_plus1", thr1, z),
        ("change_thr_exact", delta, noise), ("change_thr_plus1", delta1, noise),
    ]
